  ...
  return (
    ...
    >
      <section
        ...
        aria-modal="true"
        className={[
          "relative w-full max-w-[25.5rem] animate-soft-in overflow-hidden rounded-[26px] border border-white/80 bg-[#fffdf8] px-5 pb-5 pt-4 text-[#1f2937] shadow-[0_24px_70px_rgba(31,41,55,0.2)] sm:max-w-[28rem] sm:px-6 sm:pb-6 sm:pt-5",
