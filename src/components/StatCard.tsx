...
export default function StatCard({ title, value, note }: StatCardProps) {
  return (
    <div className="group rounded-[16px] border border-[#e6e8ec] bg-white p-2.5 text-right text-[#1d1d1f] shadow-[0_8px_20px_rgba(15,23,42,0.04)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.06)]">
      <div className="mb-1.5 h-1 w-6 rounded-full bg-[#007aff]/70" />
